...
\begin{tikzpicture}
\node[draw] (C)  at (   0,  0)   {Do};
\node[draw] (Db) at ( 1.2, -0.7) {Do $\sharp$/Ré $\flat$};
\node[draw] (D)  at ( 1.9, -1.6) {Ré};
\node[draw] (Eb) at ( 2.2, -2.5) {Ré $\sharp$/Mi $\flat$};
\node[draw] (E)  at ( 1.9, -3.3) {Mi};
\node[draw] (F)  at ( 1.2, -4) {Fa};
\node[draw] (Gb) at (   0, -4.7) {Fa $\sharp$/Sol $\flat$};
\node[draw] (G)  at (-1.2, -4) {Sol};
\node[draw] (Ab) at (-1.9, -3.3) {Sol $\sharp$/La $\flat$};
\node[draw] (A)  at (-2.2, -2.5) {La};
\node[draw] (Bb) at (-1.9, -1.6) {La $\sharp$/Si $\flat$};
\node[draw] (B)  at (-1.2, -0.7) {Si};
...
\begin{tabular}{ c p{12cm} }
    \QST{ALE} & Tirez une carte \carte{nom de note} et considérez que c’est la
                fondamentale. Donner la tierce et la quinte. Exemple : Si
                vous tirez « Fa » il faut dire « Fa, La, Do ». \\
    \QST{AVO} & Tirez une carte \carte{nom de note} et donner la note suivante
                dans l’horloge des noms de notes. Exemple : Si vous tirez
                « Fa » il faut dire « Sol ». \\
    \QST{KAP} & Tirez une carte \carte{nom de note} et donner les sept notes
                suivantes dans l’horloge des noms de notes. Exemple : Si vous
                tirez « Fa » il faut dire « Fa, Sol, La, Si, Do, Ré, Mi,
                Fa ». \\
    \QST{MAK} & Tirez une carte \carte{nom de note} et donner la note
    ...
    \QST{OLI} & Tirez une carte \carte{nom de note} et considérez que c’est la
                fondamentale. Donner la tierce, la quinte et la septième.
                Exemple : Si vous tirez « Fa » il faut dire « Fa, La, Do
                Mi ». \\
    \QST{ZIK} & Tirez une carte \carte{nom de note} et donner les sept notes
                précédentess dans l’horloge des noms de notes. Exemple : Si
...
\begin{tabular}{ | *{8}{p{0.1cm}cp{0.1cm} |} }
    \hline
    & Do &&& Ré &&& Mi &&& Fa &&& Sol &&& La &&& Si &&& Do & \\
    \hline
    & Ré $\flat$ &&& Ré &&& Mi &&& Fa &&& Sol &&& La &&& Si &&& Do & \\
    \hline
\end{tabular}
