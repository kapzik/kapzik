...
gammes, des accords, et bien d’autres choses encore ! Tout ceci fera de vous un
musicien ou une musicienne à l’aise avec la théorie de la musique !
...
de chaque joueur. Ensuite, à l’issue d’une seconde partie en
\mode{mode combat}, on note les temps de cette nouvelle partie et on compare
les améliorations de temps.
...
\begin{tabular}{ c p{12cm} }
    ...
    \QST{KAP} & Tirez une carte \carte{nom de note}, citez cette note et donnez
                ...
                Cela revient à faire un tour d’horloge.
    ...
    \QST{ZIK} & Tirez une carte \carte{nom de note}, citez cette note et donnez
                ...
                Cela revient à faire un tour d’horloge à l’envers.
