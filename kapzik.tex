...
C’est un mode « contre la montre ». Les joueurs ont tous gagné s’ils finissent
ensemble le parcours qu’ils ont choisi en moins de 10 minutes (ou toute autre
durée convenue à l’avance).

Il est possible de jouer seul.

Dans ce mode, la partie se termine dans un des deux cas suivants :
...
Il peut être sympathique d’utiliser un sablier pour contrôler la durée de la
partie.
...
Dans ce mode, la partie se termine quand il y a eu trois tours de jeu avec la
dernière question du parcours (pour le parcours \parcours{Débutant 1}, c’est la
question \QST{ZIK}).

Pensez à utiliser les fiches d’aide pour contrôler les réponses des joueurs.

Il est possible de convenir de retirer une carte si un joueur vient de la
tirer.

\subsection{Mode combat avec handicap}
